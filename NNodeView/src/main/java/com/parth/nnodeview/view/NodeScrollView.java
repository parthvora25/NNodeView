 ...
 * allowing it to be larger than the physical display. A NodeScrollView
 ...
 * takes care of its own scrolling, so does not require a NodeScrollView, but
 * using the two together is possible to achieve the effect of a text view
 * within a larger container.
 */
public class NodeScrollView extends FrameLayout {
     ...
     * code that watches for focus changes initiated outside this NodeScrollView
     * knows that it does not have to do anything.
     */
    private boolean mNodeScrollViewMovedFocus;
    ...
    /**
     * True if the user is currently dragging this NodeScrollView around. This is
     ...
     * an arrow event.
     */
    public int getMaxScrollVertical() {
        return (int) (MAX_SCROLL_FACTOR * getHeight());
    }

    public int getMaxScrollHorizontal() {
        return (int) (MAX_SCROLL_FACTOR * getWidth());
    }

    private void initNodeScrollView() {
    ...
    public void addView(View child) {
        if(getChildCount() > 0) {
            throw new IllegalStateException("NodeScrollView can host only one direct child");
        }
        super.addView(child);
    }
    ...
    /**
     * @return Returns true this NodeScrollView can be scrolled
     */
   ...
   */
    ...
    private boolean scrollAndFocus(int directionY, int top, int bottom, int directionX, int left, int right) {
        ...
        if(newFocused != findFocus() && newFocused.requestFocus(directionY)) {
            mNodeScrollViewMovedFocus = true;
            mNodeScrollViewMovedFocus = false;
        }
        return handled;
    }
    ...
    public boolean arrowScroll(int direction, boolean horizontal) {
        ...
        final int maxJump = horizontal ? getMaxScrollHorizontal() : getMaxScrollVertical();
   ...
   /* Offset from child's local coordinates to NodeScrollView coordinates */
